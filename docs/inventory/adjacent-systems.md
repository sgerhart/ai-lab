...
| **Antares** ([fdtn-ai/antares-1b](https://huggingface.co/fdtn-ai/antares-1b) / [350m](https://huggingface.co/fdtn-ai/antares-350m)) | Cisco Foundation AI vuln-localization terminal agents (Granite 4.0) | **Studio** weights + completions/jobs; mini `/antares` UI (IWO-047–049) | Prefer **1B**; LaunchAgents for completions/jobs next |
